...
if [[ "$MONGO_URL" == "" ]]
then
	echo "You need to supply your mong URL"
	echo "In the form mongodb://xx.xxx.x.xx:3302/dbname"
	echo "e.g. ./meteor-dump.sh mongodb://xx.xxx.x.xx:3302/dbname"
	exit 1
fi
...
then
	...
	#e.g mongodump -u client -h skybreak.member0.mongolayer.com:27017 -d goto_meteor_com -p 
	mongodump -u $MONGO_USER -h $MONGO_DOMAIN -db $MONGO_DB
else
